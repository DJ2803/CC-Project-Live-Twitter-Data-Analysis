...
def lambda_handler(event, context):
    # TODO implement
    query = 'Coronation OR #Coronation OR #coronation OR #CORONATION -is:retweet lang:en'
    dataList = []
    ...
    #object = s3.Object('ccfinalproject01', 'CoronationData.json')
    object = s3.Object(
        bucket_name='ccfinalproject01', 
        key='CoronationData/CoronationData.json' #folder
    )
    ...
    fig = px.bar(test1, x="possiblySensitive", y="tweetId", labels={
                 ...
                 },title='Possibly Sensitive Tweet Count: Coronation')
    ...
    filename = 'CoronationMostLiked.html'
    save_path = os.path.join(os.getcwd(), 'mydir', filename)
    ...
    client.upload_file(
        ...
        Key="CoronationOutput/PossiblySensitiveUpload.html", #folder
         )
    
    client.upload_file(
        Filename="CoronationMostLiked.html",
        Bucket="ccfinalproject01",
        Key="CoronationOutput/CoronationMostLikedUpload.html", #folder
         )
    ...
    clientS3.copy_object(Key='CoronationOutput/PossiblySensitiveUpload.html', Bucket='ccfinalproject01', #folder
                          CopySource={"Bucket": 'ccfinalproject01', "Key": 'CoronationOutput/PossiblySensitiveUpload.html'}, #folder
    ...
    client.put_object_acl(
        ACL="public-read", Bucket="ccfinalproject01", Key="CoronationOutput/PossiblySensitiveUpload.html" #folder
    )
    
    
    clientS3.copy_object(Key='CoronationOutput/CoronationMostLikedUpload.html', Bucket='ccfinalproject01', #folder
                          CopySource={"Bucket": 'ccfinalproject01', "Key": 'CoronationOutput/CoronationMostLikedUpload.html'}, #folder
                          ContentType='text/html',
                          ContentDisposition='inline', 
                          ACL='public-read', # makes the object publicly readable
                          MetadataDirective="REPLACE")
    ...
    client.put_object_acl(
        ACL="public-read", Bucket="ccfinalproject01", Key="CoronationOutput/CoronationMostLikedUpload.html" #folder
    )
